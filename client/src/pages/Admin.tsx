...
export default function Admin() {
  ...
  return (
    <div className="app-shell flex h-screen overflow-hidden font-sans">
      {/* Sidebar */}
      <aside className="w-16 md:w-20 lg:w-64 border-r flex flex-col justify-between py-6" style={{ borderColor: 'var(--glass-line)', background: 'rgba(8, 22, 41, 0.4)', backdropFilter: 'blur(20px)' }}>
        <div>
          ...
          <nav className="flex flex-col gap-2 px-2 lg:px-4">
            <button onClick={() => setLocation("/")} className="flex items-center p-2 md:p-3 rounded-xl hover:bg-white/5 opacity-70 hover:opacity-100 transition-all group">
            ...
            <button className="flex items-center p-2 md:p-3 rounded-xl transition-all border shadow-[0_0_15px_rgba(255,138,114,0.15)]" style={{ backgroundColor: 'rgba(255, 138, 114, 0.1)', borderColor: 'rgba(255, 138, 114, 0.2)', color: 'var(--glass-coral)' }}>
              <LayoutDashboard size={20} className="mx-auto lg:mx-0" />
              <span className="hidden lg:block ml-3 font-medium">Vue d'ensemble</span>
            </button>
            <button className="flex items-center p-2 md:p-3 rounded-xl hover:bg-white/5 opacity-70 hover:opacity-100 transition-all group">
        ...
        <div className="px-2 lg:px-4">
          <button onClick={handleLogout} className="w-full flex items-center p-2 md:p-3 rounded-xl hover:bg-red-500/10 opacity-70 hover:opacity-100 hover:text-red-400 transition-all group">
      ...
      {/* Main Content */}
      <main className="flex-1 flex flex-col h-full overflow-y-auto p-4 md:p-6 lg:p-10 relative">
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 md:gap-0 mb-8 lg:mb-10 z-10">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold font-display tracking-tight" style={{ color: 'var(--glass-text)' }}>Vue d'ensemble</h1>
            <p className="mt-1 text-sm md:text-base" style={{ color: 'var(--glass-muted)' }}>Gérez vos joueurs et suivez les statistiques.</p>
          </div>
          <div className="flex items-center gap-3 border p-1.5 pr-3 md:p-2 md:pr-4 rounded-full backdrop-blur-md" style={{ backgroundColor: 'var(--glass-soft)', borderColor: 'var(--glass-line)' }}>
            <div className="w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center font-bold text-sm shadow-lg text-white" style={{ background: 'linear-gradient(135deg, var(--glass-coral), #ff9a7e)' }}>
        ...
        {/* Stats Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8 lg:mb-10 z-10">
          {/* Card 1 */}
          <div className="border p-5 lg:p-6 rounded-3xl relative overflow-hidden group transition-all shadow-xl" style={{ backgroundColor: 'var(--glass-soft)', borderColor: 'var(--glass-line)', backdropFilter: 'blur(20px)' }}>
            ...
            <div className="flex justify-between items-start mb-6">
              <div>
                ...
                <h3 className="text-3xl lg:text-4xl font-bold font-display tracking-tight">{totalUsers}</h3>
              </div>
          ...
          <div className="border p-5 lg:p-6 rounded-3xl relative overflow-hidden group transition-all shadow-xl" style={{ backgroundColor: 'var(--glass-soft)', borderColor: 'var(--glass-line)', backdropFilter: 'blur(20px)' }}>
            ...
            <div className="flex justify-between items-start mb-6">
              <div>
                ...
                <h3 className="text-3xl lg:text-4xl font-bold font-display tracking-tight">{totalLevels}</h3>
              </div>
              <div className="p-3 rounded-2xl" style={{ backgroundColor: 'rgba(255, 138, 114, 0.1)', color: 'var(--glass-coral)' }}>
                <Award size={24} />
              </div>
          ...
          <div className="border p-5 lg:p-6 rounded-3xl relative overflow-hidden group transition-all shadow-xl" style={{ backgroundColor: 'var(--glass-soft)', borderColor: 'var(--glass-line)', backdropFilter: 'blur(20px)' }}>
            ...
            <div className="flex justify-between items-start mb-6">
              <div>
                ...
                <h3 className="text-3xl lg:text-4xl font-bold font-display tracking-tight">{totalXp.toLocaleString()}</h3>
              </div>
              <div className="p-3 rounded-2xl" style={{ backgroundColor: 'rgba(255, 138, 114, 0.1)', color: 'var(--glass-coral)' }}>
                <Zap size={24} />
              </div>
          ...
          <div className="border p-5 lg:p-6 rounded-3xl relative overflow-hidden group transition-all shadow-xl" style={{ backgroundColor: 'var(--glass-soft)', borderColor: 'var(--glass-line)', backdropFilter: 'blur(20px)' }}>
            ...
            <div className="flex justify-between items-start mb-6">
              <div>
                ...
                <h3 className="text-3xl lg:text-4xl font-bold font-display tracking-tight">{avgLevel}</h3>
              </div>
              <div className="p-3 rounded-2xl" style={{ backgroundColor: 'rgba(255, 138, 114, 0.1)', color: 'var(--glass-coral)' }}>
                <Activity size={24} />
              </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 z-10 flex-1">
          ...
          <div className="xl:col-span-2 border rounded-3xl flex flex-col shadow-2xl overflow-hidden" style={{ backgroundColor: 'rgba(255, 255, 255, 0.02)', borderColor: 'var(--glass-line)', backdropFilter: 'blur(20px)' }}>
            <div className="px-4 md:px-8 py-5 md:py-6 border-b flex justify-between items-center" style={{ borderColor: 'var(--glass-line)', backgroundColor: 'var(--glass-soft)' }}>
              <h2 className="text-lg md:text-xl font-bold font-display">Liste des Joueurs</h2>
            </div>
            <div className="overflow-x-auto flex-1 p-0 md:p-2">
              <table className="w-full text-left whitespace-nowrap min-w-[600px]">
                <thead className="text-xs uppercase font-bold tracking-widest" style={{ color: 'var(--glass-muted)' }}>
                  <tr>
                    ...
                    <th className="px-4 md:px-6 py-4">Statistiques</th>
                    <th className="px-4 md:px-6 py-4 text-right">Actions</th>
                  </tr>
                </thead>
                <tbody className="text-sm">
                  {users?.map(u => (
                    <tr key={u.id} className="hover:bg-white/[0.03] transition-colors rounded-xl group border-b md:border-b-0" style={{ borderColor: 'rgba(255,255,255,0.05)' }}>
                      <td className="px-4 md:px-6 py-4 rounded-l-xl">
                        <div className="flex items-center gap-3 md:gap-4">
                          <div className="w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center font-bold border shadow-inner opacity-80" style={{ backgroundColor: 'var(--glass-soft)', borderColor: 'var(--glass-line)' }}>
                          ...
                          <div>
                            {editingUserId === u.id ? (
                              <input 
                                ...
                                className="border px-3 py-1.5 rounded-lg w-28 md:w-40 outline-none text-xs md:text-sm"
                            ...
                            <p className="text-[10px] md:text-xs mt-0.5 font-medium" style={{ color: 'var(--glass-muted)' }}>{u.email || "Compte Local"}</p>
                          </div>
                        </div>
                      </td>
                      <td className="px-4 md:px-6 py-4">
                        {editingUserId === u.id ? (
                          <select 
                            ...
                            className="border px-3 py-1.5 rounded-lg outline-none text-xs md:text-sm"
                            style={{ backgroundColor: 'var(--glass-soft)', borderColor: 'var(--glass-coral)', color: 'var(--glass-text)' }}
                          >
                          ...
                          <span className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[10px] md:text-xs font-bold uppercase tracking-wider ${u.role === 'admin' ? 'shadow-[0_0_10px_rgba(255,138,114,0.1)]' : 'border'}`} style={{ 
                      ...
                      <td className="px-4 md:px-6 py-4">
                        <div className="flex flex-col gap-1">
                          <p className="font-bold text-sm" style={{ color: 'var(--glass-coral)' }}>Niv {u.level}</p>
                          <p className="text-[10px] md:text-xs font-semibold" style={{ color: 'var(--glass-muted)' }}>{u.xp} XP</p>
                        </div>
                      </td>
                      <td className="px-4 md:px-6 py-4 text-right rounded-r-xl">
                        {editingUserId === u.id ? (
                          <div className="flex justify-end gap-2">
                            <Button variant="ghost" size="icon" onClick={() => saveEdit(u.id)} disabled={updateMutation.isPending} className="h-8 w-8 md:h-10 md:w-10" style={{ backgroundColor: 'rgba(255, 138, 114, 0.1)', color: 'var(--glass-coral)' }}>
                              <Check size={16} />
                            </Button>
                            <Button variant="ghost" size="icon" onClick={() => setEditingUserId(null)} className="h-8 w-8 md:h-10 md:w-10 hover:bg-white/10 opacity-70">
                              <X size={16} />
                            </Button>
                          </div>
                        ) : (
                          <div className="flex justify-end gap-1 md:gap-2 opacity-100 lg:opacity-0 group-hover:opacity-100 transition-opacity">
                            <Button variant="ghost" size="icon" onClick={() => startEdit(u)} className="h-8 w-8 md:h-10 md:w-10 hover:bg-white/10 opacity-100 lg:opacity-70 lg:hover:opacity-100 transition-all bg-white/5">
                              <Edit2 size={14} />
                            </Button>
                            <Button variant="ghost" size="icon" onClick={() => handleDelete(u.id)} disabled={user?.id === u.id || deleteMutation.isPending} className={`h-8 w-8 md:h-10 md:w-10 transition-all ${user?.id === u.id ? 'opacity-20' : 'bg-white/5 hover:bg-red-500/20 opacity-100 lg:opacity-70 lg:hover:opacity-100 lg:hover:text-red-400'}`}>
                              <Trash2 size={14} />
                            </Button>
                          </div>
                        )}
